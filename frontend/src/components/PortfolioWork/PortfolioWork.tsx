  ...
  return (
    <>
      <Card className="application-card">
        ...
        />
        <CardContent>
          <Typography className="application-card-description">{props.applicationDescription}</Typography>
          <div className="application-card-options">
            {props.applicationOptions?.slice(0, 5).map((e) => (
              <Avatar alt={e.iconName} src={e.iconImagePath} className="avatar-option" />
            ))}
          </div>
        </CardContent>
      </Card>
